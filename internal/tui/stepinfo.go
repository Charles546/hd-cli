	...
	case 15:
		return &stepInfo{
			...
			fields: []fieldDescriptor{
				...
				{
					label:       "Driver path",
					placeholder: "./hd-driver-vault",
					help:        "Path to the secure-exec driver binary (e.g. ./hd-driver-vault)",
					getValue:    func(c *config.WizardConfig) string { return c.SecureExecDriverPath },
					setValue:    func(c *config.WizardConfig, v string) { c.SecureExecDriverPath = v },
